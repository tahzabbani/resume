...
A position in the field of software development with a special interest in web development and Python. 
...
\item[-] Updated projects written in C++ to newer specifications.
\item[-] Continuously learned more about Linux commands and their uses in streamlining tasks.
\item[-] Wrote testing scripts in Javascript. 
\end{itemize} 
